...
const updatePrice = (id, value) => {
  const convertedOldPrice = parseFloat(document.getElementById(id).innerText);
...
const updateTotal = () => {
  ...
  const delivaryCharge = parseFloat(document.getElementById('delivery-charge').innerText);
  const totalTax = parseFloat(document.getElementById('total-tax').innerText);
  const grandTotal = price + delivaryCharge + totalTax;
